sap.ui.define([], function() {
	...
	var mCfg = {
		...
		TshirtSize: {
			...
			defaultValue: "L",
			list: [
				{name: "XXXL",  text:"Female: 180cm/100A, Male: 190cm/100A"}, 
				{name: "XXL",   text:"Female: 175cm/96A , Male: 185cm/96A"}, 
				{name: "XL",    text:"Female: 170cm/92A, Male: 180cm/92A"}, 
				{name: "L",     text:"Female: 165cm/88A, Male: 175cm/88A"}, 
				{name: "M",     text:"Female: 160cm/84A, Male: 170cm/84A"}, 
				{name: "S" ,    text:"Female: 155cm/80A, Male: 165cm/80A"}, 
				{name: "XS",    text:"Female: 150cm/76A, Male: 160cm/76A"},
				{name: "XXS",   text:"Female: 145cm/72A, Male: 155cm/72A"}]
		},
